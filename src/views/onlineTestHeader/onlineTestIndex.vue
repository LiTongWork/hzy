    ...
    <div class="nav">
      <div class="separator">
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right" class="item">
          ...
          <el-breadcrumb-item :to="{ name: ''}">在线考试</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      ...
      <div class="buttons">
        <router-link :to="{ name: 'newTest' }"  v-if="loginType==2"><el-button type="primary" size="small" plain >新建考试</el-button></router-link>
      </div>
    </div>
    ...
    <div class="list-area">
      <div class="list-box">
        ...
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column align="center" prop="name" label="监考老师" v-if="loginType==2"></el-table-column>
          <el-table-column align="center" prop="startTime" label="开始时间" :formatter="changeTime1"></el-table-column>
          <el-table-column align="center" prop="endTime" label="结束时间" :formatter="changeTime2"></el-table-column>
          ...
          <el-table-column align="center" prop="status" label="状态" :formatter="changeStatus"></el-table-column>
          <el-table-column align="center" prop="edit" label="操作">
            <template slot-scope="scope">
              ...
              <el-button type="text" size="small" @click="getExamWorkList(scope.row)" v-if="loginType==3">开始考试</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
...
<script>
  export default {
    ...
    methods: {
      ...
      editExam(id){
        this.$router.push({name: 'newTest', params: {examId: id}})
      },
      //获取 在线考试/作业
      getTableDataList(){
      ...
      getExamWorkList(val){
        ...
        this.$http
          ...
          .then(res => {
            // console.log(res.data.data.examWork.status);return false
            if(res.data.data.examWork.status!=2){
              this.$router.push({name: 'readOver'})
            }else{
              this.$message({
                type: 'info',
                message: '本场考试已经结束'

  ...
  <div class="newTest">
    <el-form ref="form" :model="form" label-width="150px">
      ...
      <el-form-item label="监考老师">        
        <el-select v-model="form.proctorIds" multiple placeholder="选择监考老师" @change="selectTeacher" class="w35 block">
          <el-option
      ...
      <el-form-item>
        <el-button type="primary" @click="onSubmit" v-if="!$route.params.examId">发布考试</el-button>

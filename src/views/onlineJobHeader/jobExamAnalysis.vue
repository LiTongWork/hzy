              ...
              <el-table :data="xsfxData.tableData" style="width: 100%">
                ...
                <el-table-column align="center" label="操作">
                  <template slot-scope="scope">
                    <el-button type="text" class="text-color"><router-link :to="{name: 'answerDetail'}" tag="span">答卷详情</router-link></el-button>
                  </template>
                </el-table-column>
              </el-table>
            </div>
...
<style lang="scss" rel="stylesheet/scss">
  ...
  .gkfx {
    .grade, .difficulty, .accuracy, .comment {
      margin-top: 20px;
    ...
    .gradePie, .difficultyPie, .accuracyBar, .commentText {
      height: 260px;
    }
    .commentText {
      display: table;

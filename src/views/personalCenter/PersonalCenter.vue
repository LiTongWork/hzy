<template>
  <div class="personalCenter">
    <div class="menu">
      ...
      <el-menu class="el-menu-vertical-demo" :default-openeds='openeds' :default-active="index" @select="changeIndex" @open="handleOpen" @close="handleClose">
        <el-submenu index="1">
          <template slot="title">
          ...
          <el-menu-item-group>
            ...
            <el-menu-item index="1-2" class="list-item"><router-link tag="span" :to="{name: 'createdCourse'}">创建的课程</router-link></el-menu-item>
            <el-menu-item index="1-3" class="list-item"><router-link tag="span" :to="{name: 'createdKnowLedge'}">创建的知识点</router-link></el-menu-item>

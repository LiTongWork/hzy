<template>
	<div class="createdCourse">
		<div class="header-wrapper">
			<div class="title">
				...
				<el-select v-model="cource" placeholder="选择课程" @change="changeCource" style="float:right;">
					<el-option v-for="(item,index) in courceOptions" :key="index" :label="item.courseName" :value="item.id"></el-option>
				</el-select>
			</div>
		</div>
		...
		<div class="content-wrapper">
			<div class="list">
				<el-tree :data="data" node-key="id" :default-expand-all="true" :expand-on-click-node="false" @node-drag-start="handleDragStart"
				 @node-drag-enter="handleDragEnter" @node-drag-leave="handleDragLeave" @node-drag-over="handleDragOver"
				 @node-drag-end="handleDragEnd" @node-drop="handleDrop" @node-click="handClick" draggable :allow-drop="allowDrop"
